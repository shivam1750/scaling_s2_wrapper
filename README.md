...
## News
- [2024/05] S<sup>2</sup>-Wrapper is officially integrated in NVIDIA [VILA](https://github.com/Efficient-Large-Model/VILA)! We've released the checkpoint for VILA-1.5-7b with S<sup>2</sup> and more checkpoints are on the way! Check it out [here](#example-nvidia-vila-with-s2-wrapper).
